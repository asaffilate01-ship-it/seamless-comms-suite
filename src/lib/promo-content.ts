...
const ar: PromoContent = {
  ...
  hero: {
    ...
    titleB: "نظام واحد.",
    sub: "يحوّل OmniQora كل تواصل مع العملاء إلى عملية عمل منضبطة: الاستقبال، التأهيل، العرض، الموعد، التنفيذ والمتابعة — متوافق مع GDPR ومستضاف في عدة مراكز بيانات.",
...
const fr: PromoContent = {
  ...
  hero: {
    badge: "",
    titleA: "Tous vos clients. Toutes vos conversations.",
    titleB: "Un seul système.",
    sub: "OmniQora transforme chaque conversation client en processus maîtrisé : demande, qualification, devis, rendez-vous, exécution et suivi — conforme au RGPD et hébergé dans plusieurs centres de données.",
