...
const de: PromoContent = {
  ...
  hero: {
    ...
    titleB: "Ein System.",
    sub: "OmniQora macht jede Kundenkommunikation zum kontrollierten Geschäftsprozess: Anfrage, Qualifizierung, Angebot, Termin, Ausführung und Nachfassen – DSGVO-konform und in der EU gehostet.",
...
const en: PromoContent = {
  ...
  hero: {
    ...
    titleB: "One system.",
    sub: "OmniQora turns every customer conversation into a controlled business process: intake, qualification, quote, scheduling, fulfilment and follow-up — GDPR-first and hosted in the EU.",
...
const tr: PromoContent = {
  ...
  hero: {
    ...
    titleB: "Tek sistem.",
    sub: "OmniQora tüm müşteri iletişimini kontrollü bir iş sürecine dönüştürür: talep, değerlendirme, teklif, randevu, uygulama ve takip — KVKK/GDPR uyumlu ve AB'de barındırılır.",
