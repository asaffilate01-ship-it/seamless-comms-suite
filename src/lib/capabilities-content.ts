    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Veyumo & Cirqiva", text: "Weitere Portfolio-Dienste, u. a. für Kreislaufwirtschaft." },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Veyumo & Cirqiva", text: "Further portfolio services, including circular economy." },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Veyumo & Cirqiva", text: "Döngüsel ekonomi dahil diğer portföy hizmetleri." },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Veyumo و Cirqiva", text: "خدمات أخرى من المحفظة، منها الاقتصاد الدائري." },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Veyumo & Cirqiva", text: "Autres services du portefeuille, dont l’économie circulaire." },
