...
const sections = {
  de: [
    ["1. Verantwortlicher", "OmniQora GmbH, Musterstraße 1, 10115 Berlin, hallo@omniqora.de. Datenschutzbeauftragter: dsb@omniqora.de."],
    ...
    ["9. Betroffenenrechte", "Auskunft (Art. 15), Berichtigung (Art. 16), Löschung (Art. 17), Einschränkung (Art. 18), Datenübertragbarkeit (Art. 20), Widerspruch (Art. 21) sowie Beschwerde bei einer Aufsichtsbehörde (Art. 77). Anfragen an dsb@omniqora.de."],
  ...
  en: [
    ["1. Controller", "OmniQora GmbH, Musterstraße 1, 10115 Berlin, Germany, hallo@omniqora.de. Data protection officer: dsb@omniqora.de."],
    ...
    ["9. Your rights", "Access (Art. 15), rectification (Art. 16), erasure (Art. 17), restriction (Art. 18), portability (Art. 20), objection (Art. 21) and the right to lodge a complaint with a supervisory authority (Art. 77). Requests to dsb@omniqora.de."],
    ...
    <div className="min-h-screen">
      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {de ? "Stand: laufende Fassung. Gilt für omniqora.de und die OmniQora-Plattform." : "Current version. Applies to omniqora.de and the OmniQora platform."}
        </p>
