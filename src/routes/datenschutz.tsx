...
const sections = {
  de: [
    ...
    ["5. Empfänger und Drittlandtransfer", "WhatsApp Business Platform (Meta Platforms Ireland Ltd.) verarbeitet Nachrichten zwingend zur Übermittlung; Transfers in die USA erfolgen auf Basis von Standardvertragsklauseln und dem EU-US Data Privacy Framework. Hosting und Datenbank werden in der EU  betrieben."],
  ...
  en: [
    ...
    ["5. Recipients and international transfers", "The WhatsApp Business Platform (Meta Platforms Ireland Ltd.) necessarily processes messages for delivery; US transfers rely on Standard Contractual Clauses and the EU-US Data Privacy Framework. Hosting and database run in the EU ."],
