...
export const Route = createFileRoute("/datenschutz")({
  head: () => ({
    meta: [
      { title: "Datenschutzerklärung — Konnevia" },
      {
        name: "description",
        content:
          "Wie Konnevia personenbezogene Daten in WhatsApp-Workflows verarbeitet: Rechtsgrundlagen, Auftragsverarbeitung, Speicherfristen und Betroffenenrechte nach DSGVO.",
      },
      { property: "og:title", content: "Datenschutzerklärung — Konnevia" },
      { property: "og:description", content: "DSGVO-Informationen zur Datenverarbeitung in Konnevia." },
...
const sections = {
  de: [
    ["1. Verantwortlicher", "Konnevia GmbH, Musterstraße 1, 10115 Berlin, hallo@konnevia.de. Datenschutzbeauftragter: dsb@konnevia.de."],
    ...
    ["4. Auftragsverarbeitung", "Für Kundenunternehmen ist Konnevia Auftragsverarbeiter nach Art. 28 DSGVO; der Kunde bleibt Verantwortlicher für die Inhalte seiner Konversationen. Ein AV-Vertrag inklusive Subunternehmerliste wird bereitgestellt."],
    ...
    ["9. Betroffenenrechte", "Auskunft (Art. 15), Berichtigung (Art. 16), Löschung (Art. 17), Einschränkung (Art. 18), Datenübertragbarkeit (Art. 20), Widerspruch (Art. 21) sowie Beschwerde bei einer Aufsichtsbehörde (Art. 77). Anfragen an dsb@konnevia.de."],
  ...
  en: [
    ["1. Controller", "Konnevia GmbH, Musterstraße 1, 10115 Berlin, Germany, hallo@konnevia.de. Data protection officer: dsb@konnevia.de."],
    ...
    ["4. Processing on behalf of customers", "For business customers Konnevia acts as processor under Art. 28 GDPR; the customer remains controller for conversation content. A DPA including the sub-processor list is provided."],
    ...
    ["9. Your rights", "Access (Art. 15), rectification (Art. 16), erasure (Art. 17), restriction (Art. 18), portability (Art. 20), objection (Art. 21) and the right to lodge a complaint with a supervisory authority (Art. 77). Requests to dsb@konnevia.de."],
    ...
    <div className="min-h-screen">
      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {de ? "Stand: laufende Fassung. Gilt für konnevia.de und die Konnevia-Plattform." : "Current version. Applies to konnevia.de and the Konnevia platform."}
        </p>
