...
const sections = {
  ...
  en: [
    ...
    ["5. Recipients and international transfers", "The WhatsApp Business Platform (Meta Platforms Ireland Ltd.) necessarily processes messages for delivery; US transfers rely on Standard Contractual Clauses and the EU-US Data Privacy Framework. Hosting and database run across multiple data centres."],
