...
export const Route = createFileRoute("/compliance")({
  head: () => ({
    meta: [
      { title: "Compliance & security — OmniQora" },
      ...
      { property: "og:title", content: "Compliance & security — OmniQora" },
      { property: "og:description", content: "German compliance posture, data classification and security controls of OmniQora." },
    ],
  }),
