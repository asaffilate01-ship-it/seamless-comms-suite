...
function Settings() {
  return (
    <AppShell title="Settings" subtitle="Tenant, roles, channel, AI, compliance and branding">
      <VeyumoMobile />
      <Tabs defaultValue="tenant" className="w-full">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <Toggle
                  ...
                  hint="Message sending disabled outside opt-in list"
                  on={false}
                />
        ...
        <TabsContent value="channel">
          <Card>
            <CardContent className="p-6 space-y-6">
              <div className="flex items-center gap-3 rounded-lg border border-border bg-surface-2 p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Cloud API · Meta authorised BSP · Business verified
                  </div>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Toggle
                  label="Auto-reply outside hours"
                  hint="Sends approved template out_of_hours_de"
                  on
                />
                ...
                <Toggle
                  label="Media retention 30 days"
                  hint="Purge attachments after 30d unless referenced"
                  on
                />
              </div>
            </CardContent>
        ...
        <TabsContent value="roles">
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Approvals: dual-control triggered on quotes &gt; €500, template edits and role changes.
          </p>
        </TabsContent>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3 rounded-lg border border-border bg-primary-soft/50 p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Model preset: Beauty-DE · Handoff threshold: 0.72
                  </div>
                </div>
              </div>
              <div className="grid gap-4 md:grid-cols-2">
        ...
        <TabsContent value="compliance">
          <Card>
            <CardContent className="p-6 space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <Field label="Data residency" value="Multiple data centres" />
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-lg border border-border p-4">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Requires reason, expiry, alert, post-access review.
                  </div>
                </div>
                <div className="rounded-lg border border-border p-4">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Message keys rotated every 90 days.
                  </div>
                </div>
                <div className="rounded-lg border border-border p-4">
                  <ShieldCheck className="h-4 w-4 text-primary" />
                  ...
                  <div className="text-xs text-muted-foreground">
                    Export, rectification, erasure per purpose.
                  </div>
                </div>
              </div>
            </CardContent>
