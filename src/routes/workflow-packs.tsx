...
export const Route = createFileRoute("/workflow-packs")({
  head: () => ({
    meta: [
      { title: "Workflow packs — LoungeConnect" },
      ...
      { property: "og:title", content: "Workflow packs — LoungeConnect" },
      { property: "og:description", content: "Vertical WhatsApp workflow packs bundled with LoungeConnect." },
    ],
  }),
  component: Packs,
});
    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-16">
        <div className="max-w-2xl">
          <Badge variant="outline" className="border-primary/30 bg-primary/5 text-primary">Vertical workflow packs</Badge>
          <h1 className="mt-4 font-display text-4xl font-semibold md:text-5xl">
            Every LoungeTech product ships with the right playbook.
          </h1>
          <p className="mt-3 text-muted-foreground">
            Packs bundle prompts, templates, workflows, roles and analytics for a specific vertical.
            Extend them in the workflow builder — but the defaults already work.
          </p>
        </div>
            ...
            <article key={p.name} className="overflow-hidden rounded-2xl border border-border bg-card">
              <div className="border-b border-border bg-surface-2 px-6 py-5">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="border-primary/30 bg-primary/5 text-primary text-[10px]">Preinstalled</Badge>
                </div>
